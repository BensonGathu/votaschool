...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('Form One Term One', 'Form One Term One'), ('Form One Term Two', 'Form One Term Two'), ('Form One Term Three', 'Form One Term Three'), ('Form Two Term One', 'Form Two Term One'), ('Form Two Term Two', 'Form Two Term Two'), ('Form Two Term Three', 'Form Two Term Three'), ('Form Three Term One', 'Form Three Term One'), ('Form Three Term Two', 'Form Three Term Two'), ('Form Three Term Three', 'Form Three Term Three'), ('Form Four Term One', 'Form Four Term One'), ('Form Four Term Two', 'Form Four Term Two'), ('Form Four Term Three', 'Form Four Term Three')], max_length=1000)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('teachers', models.ManyToManyField(blank=True, null=True, to='school.Teacher')),
            ],
        ),
        migrations.CreateModel(
            name='Student',
